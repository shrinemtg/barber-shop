  ...
  return (
    <Section>
      ...
      <DescriptionWrap>
        ...
        <Description>
          hair gebr Yokotaは、お客様に安心して施術を受けていただくために、事前のカウンセリングを徹底しています。お客様の髪の悩みや理想のスタイルを丁寧に把握し、最適な施術プランをご提案いたします。カット・カラー・パーマ・トリートメントに加え、多様なメニューを取り揃えておりますので、どんなことでもお気軽にお問い合わせください。
        </Description>
        <ReservationBoxWrap>
          <ArrowImg
